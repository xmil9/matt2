...
{
   {
      ...
      Game g{Position{"Kba1 Kwh8"}, Color::Black};
      VERIFY(g.countMoves() == 0, caseLabel);
      VERIFY(g.currentMoveIdx() == -1, caseLabel);
...
{
   {
      ...
      VERIFY(Game().nextTurn() == Color::White, caseLabel);
      VERIFY(Game(pos, Color::White).nextTurn() == Color::White, caseLabel);
      VERIFY(Game(pos, Color::Black).nextTurn() == Color::Black, caseLabel);
   }
}
...
void testCalcNextMove()
{
...

   {
      ...
      Game g{Position{"Kwb1 Rwe4 Bwg4 Kbd8 Bbf5"}, Color::Black};
   ...
   }
   {
      ...
      Game g{Position{"Kwa1 Kbd4 wc3"}, Color::White};
      const auto& nextPos = g.calcNextMove(1);
   ...
   }
   {
      ...
      Game g{Position{"Kwb2 Bwg3 Nwf4 wb6 Kbe8 Qbd6"}, Color::Black};
      const auto& nextPos = g.calcNextMove(1);
   ...
   }
   {
      ...
      Game g{Position{"Kwc1 Rwf7 Rwg1 Kbc8"}, Color::White};
...
{
   {
      ...
      VERIFY(Game(pos, Color::White).current() == pos, caseLabel);
   }
}
